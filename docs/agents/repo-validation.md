...
lastReviewedNote: 'Reviewed for Edge #363: JWT/service-only auth proof removes legacy bearer and generic Redis coverage, retains 155 roots/73 Node tests, and runs 499 default Deno tests plus one opt-in Portal Upstash test.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
