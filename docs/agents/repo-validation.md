...
lastReviewedNote: 'Reviewed for Edge #369 promote feedback: deterministic tests additionally prove cache-write failure is captured before a Database rejection event is sanitized; the full baseline is 155 roots, 73 Node tests, and 506 Deno tests.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
