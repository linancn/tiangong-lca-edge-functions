...
lastReviewedNote: 'Updated for Issue #250: schema-boundary proof includes bounded object-property alias tracking in addition to manifest, expand-audit, fail-closed contract, and coordinated database validation.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
