...
lastReviewedNote: 'Reviewed for Edge #377: invalid bearer proof covers SDK status 400 as canonical 401, while status 0, 429, and 5xx retain retryable infrastructure semantics; the complete runtime gate remains mandatory.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
