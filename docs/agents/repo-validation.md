...
lastReviewedNote: 'Reviewed for Edge #369: deterministic concurrency tests cover parallel circuit/cache reads, circuit-open precedence, and overlapped cache-write/Database work under the fixed deadline; the full baseline is 155 roots, 73 Node tests, and 505 Deno tests.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
