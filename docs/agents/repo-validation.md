...
lastReviewedNote: 'Reviewed for Issue #235 Contract cleanup: the retired generic non-FT embedding route is absent from source and validation inventory; active embedding_ft and all seven Hybrid routes remain in the default proof baseline.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
