...
lastReviewedNote: 'Reviewed after synchronizing Edge #363, #369, and #373: JWT/service-only auth remains intact while deterministic and real-Upstash tests prove Hybrid atomic replay/recovery/admission/circuit order; the baseline is 155 roots, 73 Node tests, and 504 Deno tests.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
