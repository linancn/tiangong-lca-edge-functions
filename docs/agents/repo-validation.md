...
lastReviewedCommit: a720bc0d701a537f8ea3ec6dfdb8df4fae0dd790
lastReviewedNote: 'Reviewed for Edge #369 feedback: deterministic tests additionally prove open circuit does not wait for stalled cache and invalid request wins over cache failure; the full baseline remains 155 roots, 73 Node tests, and 505 Deno tests.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
