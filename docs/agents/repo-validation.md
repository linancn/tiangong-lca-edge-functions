...
lastReviewedNote: 'Reviewed persistent-dev embedding backfill connection pressure: local pool-option regression plus non-production connection return-to-baseline and queue-outcome proof are explicit.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
