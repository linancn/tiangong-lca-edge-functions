...
lastReviewedNote: 'Reviewed for Edge #373 feedback: source-order assertions plus real Upstash prove nonce/replay, expired-lease recovery, budgets, concurrency/lease and circuit ordering; the baseline remains 155 roots, 73 Node tests, and 507 Deno tests.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
