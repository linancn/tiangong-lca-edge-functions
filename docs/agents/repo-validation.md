...
lastReviewedNote: 'Reviewed for Issue #233 Request Changes: proof now covers recursive projection leaks, unexpected RPC failures, every Storage signing failure mode, real SDK HTTP transport, and expiry-skew boundaries.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
