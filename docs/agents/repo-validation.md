...
lastReviewedNote: 'Reviewed for Edge #340: the Portal R2 proof now requires concurrent admitted provider start, original-query embedding, shared abort and database-after-both ordering without changing the global validation baseline.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
