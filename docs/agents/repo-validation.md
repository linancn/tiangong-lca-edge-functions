...
lastReviewedNote: 'Updated for Issue #250: schema-boundary changes require manifest coverage, expand audit, fail-closed contract proof, and coordinated database contract validation.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
