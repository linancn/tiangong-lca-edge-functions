...
lastReviewedNote: 'Reviewed for Issue #233: closure artifact proof covers the bounded XLSX and machine-manifest selectors, exact two-argument RPC forwarding, semantic filenames, expiry-capped signing, stable lifecycle errors, and locator-free read/download projections.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
