...
lastReviewedNote: 'Updated for Issue #250: schema-boundary authorization is syntax-first, exact-counted, and limited to the current incremental slice.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
