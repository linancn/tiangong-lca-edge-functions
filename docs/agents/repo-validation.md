...
lastReviewedNote: 'Updated for Issue #249: Worker capability proof now covers explicit api v1 routines, consumer-zero, and the pinned hosted Preview profile/auth matrix.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
