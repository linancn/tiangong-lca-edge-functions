...
lastReviewedNote: 'Reviewed for Edge #351: auth proof now distinguishes claims-first JWT, fresh-user lookup, minimal principal propagation, and lazy legacy Redis without changing Portal isolation.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
