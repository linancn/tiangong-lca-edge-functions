...
lastReviewedNote: 'Reviewed while integrating Edge #363 and #369: JWT/service-only auth and Portal-only Redis retain the 155-root/73-Node/503-Deno baseline plus settled Portal telemetry proof.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
