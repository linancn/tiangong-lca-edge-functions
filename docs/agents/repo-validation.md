...
lastReviewedNote: 'Reviewed after Issue #310 deadline remediation: validation proves final-decision event parity plus bounded waitUntil/macrotask delivery for slow, throwing, rejecting, and never-settling R2 loggers.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
