...
lastReviewedNote: 'Reviewed for Edge #369 feedback: the shared deadline starts cache concurrently but returns open circuit immediately and validates payload before cache faults, retaining provider ordering and bounded cleanup.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
