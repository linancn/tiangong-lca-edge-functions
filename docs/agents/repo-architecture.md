...
lastReviewedNote: 'Reviewed for Edge #403: shared Hybrid architecture now distinguishes Process/Flow matched V2 forwarding and Database-owned fallback from foundation-route Edge fallback, with redacted stage timing.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
