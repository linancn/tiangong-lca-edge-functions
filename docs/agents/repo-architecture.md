...
lastReviewedNote: 'Reviewed for Edge #340: the Portal Hybrid cache-miss provider calls now run concurrently under the existing deadline while repo topology, generic kernels and ownership remain unchanged.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
