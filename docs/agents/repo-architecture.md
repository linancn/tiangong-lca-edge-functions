...
lastReviewedNote: 'Updated for Issue #246: Worker control-plane access is centralized behind a service-only capability repository and no runtime consumer reads the physical worker_jobs relation.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
