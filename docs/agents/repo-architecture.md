...
lastReviewedNote: 'Updated for Issue #250: schema-boundary proof follows statically resolvable object-property aliases with bounded, cycle-checked analysis.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
