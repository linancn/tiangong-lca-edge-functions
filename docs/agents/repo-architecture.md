...
lastReviewedNote: 'Reviewed for Edge #363: shared auth is Supabase JWT/service-only, generic auth Redis and legacy bearer modules are gone, and Portal plus the independently owned Cognito bridge remain isolated.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
