...
lastReviewedNote: 'Reviewed for Edge #369: the shared deadline architecture now overlaps only independent post-admission Redis and Database work while retaining circuit precedence, provider ordering, and bounded cleanup.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
