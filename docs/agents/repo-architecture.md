...
lastReviewedNote: 'Reviewed for Edge #373: Portal Redis architecture adds one Hybrid atomic begin without changing LCIA guards, cache authority, provider ordering, Database ownership, or bounded cleanup.'
related:
  - ../../AGENTS.md
  - ../../.docpact/config.yaml
  - ./repo-validation.md
