...
lastReviewedNote: 'Reviewed for Edge #373 feedback: operator guidance now states the exact nonce/replay, expired-lease recovery, budget/concurrency/lease, then circuit order enforced by the one-call Hybrid contract.'
---
