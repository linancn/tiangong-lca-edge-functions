...
lastReviewedNote: 'Reviewed for Edge #340: Portal Hybrid now overlaps admitted rewrite and original-query embedding under the same deadline without changing provider isolation, response privacy or generic Hybrid behavior.'
---
