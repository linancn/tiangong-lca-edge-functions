...
lastReviewedNote: 'Reviewed for Edge #373: operator guidance records the one-call Hybrid replay/budget/concurrency/lease/circuit contract, separate valid-request cache read, and unchanged 6000 ms deadline.'
---
