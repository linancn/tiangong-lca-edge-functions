...
lastReviewedNote: 'Reviewed for Edge #373 feedback: the corrected recovery-before-budget/concurrency description matches the executable Lua and preserves HMAC, replay, circuit, cache, provider, privacy, fallback, and branch boundaries.'
related:
  - .docpact/config.yaml
