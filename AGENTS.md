...
lastReviewedNote: 'Reviewed for Edge #369 feedback: circuit is awaited before cache and request validation precedes cache-result consumption, preserving auth, rejection order, provider isolation, budgets, fallback, privacy, and branch boundaries.'
related:
  - .docpact/config.yaml
